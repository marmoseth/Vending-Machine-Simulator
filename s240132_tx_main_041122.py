...
This is not my main submission for the assessment. I am including it to demonstrate an earlier (text) version
of the assessment. This version primarily uses while loops in order to create a finite state machine.
"""
